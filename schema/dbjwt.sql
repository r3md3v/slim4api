...
INSERT INTO `usersjwt` (`JWUUSERNAME`, `JWUPASSWORD`, `JWUEMAIL`, `JWUDESCRIPTION`, `JWULASTTOKEN`, `JWUSTATUS`,
                        `JWUCREATED`, `JWUMODIFIED`)
VALUES ('MikeD', '$2y$10$2OdnMJ2v23vmmv7PzgFjr.exxcGinHucbAFqkM38qbBlOJOfQ0Age', 'mike@codeofaninja.com',
        'Mike Dalisay codeofaninja.com', false, '1', now(), now()),
       ('user', '$2y$10$zz81A20v7euIGy/GBtd4aePUXN9/ydknQgqt.cGINk4FeDASiS1tS', 'user@slim4api.com',
        'user/password login for testing JWT in Slim4API',
        ...
        '1', now(), now()),
       ('nogo', '$2y$10$zz81A20v7euIGy/GBtd4aePUXN9/ydknQgqt.cGINk4FeDASiS1tS', 'inactive@user.com',
        'Inactive user to test exception on login function', false, '0', now(), now())
;
